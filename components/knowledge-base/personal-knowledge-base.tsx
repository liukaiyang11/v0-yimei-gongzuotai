    ...
    <div className="space-y-6">
      ...
      <Dialog open={dialogType === "move"} onOpenChange={closeDialog}>
        <DialogContent className="sm:max-w-[600px] bg-card/95 backdrop-blur-md border-2 border-border shadow-2xl">
          ...
          <div className="py-4 max-h-[400px] overflow-y-auto border-2 rounded-lg bg-background/50">
      ...
      <Dialog open={dialogType === "view"} onOpenChange={closeDialog}>
        <DialogContent className="sm:max-w-[900px] max-h-[80vh] bg-card/95 backdrop-blur-md border-2 border-border shadow-2xl">
          <DialogHeader>
